				...
				<tr>
                  <td align="center" colspan="2">
					<div style="color:#333;font-family:'Noto Sans Korean';font-size:16px;text-align:left;width:580px;word-break:break-all;">
						제출하신 RIZON 지갑주소 <strong style="color:#00b1e9;font-size:16px;word-break:break-all;">{address}</strong>에 대한 스왑이(교환) 정상적으로 완료됐습니다.<br><br>
						해당 스왑에 대한 txid 는 다음과 같습니다.<br>
					...
					<div style="color:#333;font-family:'Noto Sans Korean';font-size:16px;text-align:left;width:580px;word-break:break-all;">
						The swap submitted successfully<br>
						Swap regarding RIZON Wallet Address<strong style="color:#00b1e9;font-size:16px;">({address})</strong> has been completed successfully.<br><br>

						The txid of the Swap<br>
