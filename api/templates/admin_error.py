				...
				<tr>
                  <td align="center" colspan="2">
					<div style="color:#333;font-family:'Noto Sans Korean';font-size:16px;text-align:left;width:580px;word-break:break-all;">
						KYC/AML 과정에서 제출하신 RIZON 지갑주소 <strong style="color:#00b1e9;font-size:16px;">{address}</strong>로 관리자 권한 오류입니다.<br><br>
					...
					<div style="color:#333;font-family:'Noto Sans Korean';font-size:16px;text-align:left;width:580px;word-break:break-all;">
						The RIZON Wallet Address<strong style="color:#00b1e9;font-size:16px;">({address})</strong> Admin error occured.<br><br> 
