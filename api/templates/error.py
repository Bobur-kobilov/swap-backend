              ...
              <tbody>
				...
				<tr>
                  <td align="center" colspan="2">
					...
					제출하신 RIZON 지갑주소 <strong style="color:#00b1e9;font-size:16px;">{address}</strong>로 오류 발생했습니다.<br><br>
					...
					<div style="color:#333;font-family:'Noto Sans Korean';font-size:16px;text-align:left;width:580px;word-break:break-all;">
						The RIZON Wallet Address<strong style="color:#00b1e9;font-size:16px;">({address})</strong> error occured.<br><br> 
